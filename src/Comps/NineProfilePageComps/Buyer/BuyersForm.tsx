...
import { add_buyer, get_district, get_state, methodGet, methodPost} from "../../../API_Service/API_Service";
 ...
 // POST FETCH
    useEffect(() => {
        if(buyerState !== null ){
            ...
            lData.append('StateId', buyerState.StateId.toString());
            axios({
                method: methodPost,
                url: get_district,
                data: lData,
                        ...
                        <Grid container mt={2}>
                            <Grid item xs={12} md={12} lg={12} xl={12}>
                                <Box width='100%' textAlign='center' py={2}>
                                    <Typography variant="h5" color='#262626' sx={{ textDecoration: 'underline', lineHeight: 1 }} fontWeight={600} >Purchase/Contract Information</Typography>                  </Box>
                            </Grid>
                        </Grid>
                    </Box>
                </Container>
