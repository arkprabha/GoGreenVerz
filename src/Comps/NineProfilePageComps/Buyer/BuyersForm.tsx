                    ...
                    <Box mb={1}>
                        <Grid container>
                            ...
                            <Box width='100%' textAlign='center' py={2} className="text-container">
                                                                            <Typography className="FormheadingName" sx={{fontSize:'2.5rem' , fontWeight:700 ,letterSpacing:'0.3rem' ,textTransform:'uppercase' }} >Purchase/Contract Information</Typography>                  </Box>
                            </Grid>
                        </Grid>
                    </Box>
                </Container>
