...
import { add_admin, get_district, get_state, methodGet, methodPost } from "../../../API_Service/API_Service";
                        ...
                        <Grid container mt={2}>
                            <Grid item xs={12} md={12} lg={12} xl={12}>
                                <Box width='100%' textAlign='center' py={2}>
                                    <Typography variant="h5" color='#262626' sx={{ textDecoration: 'underline', lineHeight: 1 }} fontWeight={600} >Admin Form</Typography>                  </Box>
                            </Grid>
                        </Grid>
                    </Box>
                </Container>
