...
import { get_land_by_profile_users, get_city, get_state, methodGet, methodPost, update_cri} from "../../../API_Service/API_Service";
 ...
 // POST FETCH
    useEffect(() => {
        if(CRIState !== null ){
            ...
            lData.append('StateId', CRIState.StateId);
            axios({
                method: methodPost,
                url: get_city,
                data: lData,
                    ...
                    <Box mb={1}>
                        <Grid container>
                            ...
                            <Box width='100%' textAlign='center' py={2} className="text-container">
                                                                            <Typography className="FormheadingName" sx={{fontSize:'2.5rem' , fontWeight:700 ,letterSpacing:'0.3rem' ,textTransform:'uppercase' }} >Edit CRI Submission Form</Typography>                  </Box>
                            </Grid>
                        </Grid>
                    </Box>
                </Container>
