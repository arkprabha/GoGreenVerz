  ...
  const resetFilter = () =>{
    ...
    return (
          ...
          <Container>
            <Box mb={1}>
              ...
              <Box width='100%' textAlign='center' py={2} className="text-container">
                <Typography className="FormheadingName" sx={{fontSize:'2.5rem' , fontWeight:700 ,letterSpacing:'0.3rem' ,textTransform:'uppercase' }} >My Filled Lands</Typography>                  </Box>
                </Grid>
        ...
        <Grid container spacing={1} display='flex' justifyContent='start' px={1}>
          ...
          <Grid item xs={12} sm={6} md={3} lg={3} key={i.PlantationPartnerId} my={2}>
        ...
        <Skeleton sx={{ height: 190 }} animation="wave" variant="rectangular" />
          ...
          <>
                          <Typography gutterBottom variant="h5" component="div" textAlign='left' color="#455636">
            {i.PlantationPartnerId}
            </Typography>
            <Stack spacing={1}>
            <Box display='flex' gap={1} flexDirection='row'>
            <Typography variant="body2" color="#455636" fontWeight={600}>Located:</Typography>
                              <Typography variant="body2" color="#455636">{i.PlantationPartnerCity}, {i.PlantationPartnerState}, {i.PlantationPartnerCountry}</Typography>
            </Box>
            <Box display='flex' gap={1} flexDirection='row'>
          ...
          <React.Fragment>
           ...
           <Box display='flex' justifyContent='space-between' flexDirection='row'>
            ...
            <Button size="small" sx={{ color: '#D6A31E' }} onClick={()=>movedtoEditPage(i.PlantationPartnerId)}>
             Update
            </Button>
            </Box>
)}            
