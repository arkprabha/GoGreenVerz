  ...
  const resetFilter = () =>{
    ...
    return (
          ...
          <Container>
            <Box mb={1}>
              ...
              <Box width='100%' textAlign='center' py={2} className="text-container">
               <Typography className="FormheadingName" sx={{fontSize:'2.5rem' , fontWeight:700 ,letterSpacing:'0.3rem' ,textTransform:'uppercase' }} >Your Work Submissions</Typography>                  </Box>
                </Grid>
                <Grid item xs={12} md={12} lg={12} xl={12}>
        ...
        <Grid container spacing={1} display='flex' justifyContent='start' px={1}>
          {VVBList.map((i) => (
            <Grid item xs={12} sm={6} md={3} lg={3} key={i.VVBId} my={2}>
        ...
        <Skeleton sx={{ height: 190 }} animation="wave" variant="rectangular" />
          ...
          <>
            ...
            <Typography variant="body2" color="#455636" fontWeight={600}>Located:</Typography>
                                <Typography variant="body2" color="#455636">{i.VVBCity}, {i.VVBState}, {i.VVBCountry}</Typography>
            </Box>
            <Box display='flex' gap={1} flexDirection='row'>
            <Typography variant="body2" color="#455636" fontWeight={600}>Status:</Typography>
                                <Typography variant="body2" color="#455636"> {i.VVBStatus}</Typography>
            </Box>
            </Stack>
            </>
        )}
          ...
          <React.Fragment>
           ...
           <Box display='flex' justifyContent='space-between' flexDirection='row'>
            ...
            View
                          ...
                          <Button size="small" sx={{ color: '#D6A31E' }} onClick={()=>movedtoEditPage(i.VVBId)}>
             Update
            </Button>
            </Box>
)}            
