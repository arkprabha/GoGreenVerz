...
import { LandOwnerFiles, get_project_developer, get_state, methodGet } from '../../../API_Service/API_Service';
...
const GoProjectUpdatedLands: React.FC = () => {
  ...
  const [selectedItem, setSelectedItem] = useState<GoProjectData | null>(null);
  ...
  const handleOpenDialog = (item : GoProjectData) => {
...
const handleSearchChange = (event: ChangeEvent<{} | any>, newValue: State | null) => {
  ...
  const handleSearch = () => {
    ...
    const {DeveloperAddress1, DeveloperAddress2 ,DeveloperOwnerId, DeveloperCity, DeveloperState, DeveloperCountry, Latitude, Longitude } = i;
      ...
      const matchesAddress1 = DeveloperAddress1.toLowerCase().includes(searchQuery.toLowerCase());
      ...
      return (
        ...
        matchesAddress1 ||
        matchesAddress2 ||
        matchesDeveloperCountry ||
        matchesDeveloperOwnerId ||
        matchesLatitude ||
        matchesLongitude
      );
    });
  ...
  const resetFilter = () =>{
    ...
    return (
        <Box>
           ...
           <SnackBar open={open} setOpen={setOpen} message={message} color={color} status={status} />
            ...
            <GoProjectLandDialog openDialog={openDialog} setOpenDialog={setOpenDialog} i={selectedItem} />
             ...
             <Container>
                    ...
                    <Typography className="FormheadingName" >Submitted Lands</Typography>                  </Box>
                                </Grid>
                            </Grid>
                        </Box>
                    </Container>
          ...
          <TextField
          {...params}
          placeholder="Search Developer's Data By Address, ID, Lat"
          variant="standard"
          sx={{ width: '25ch' }}
...
export default GoProjectUpdatedLands;