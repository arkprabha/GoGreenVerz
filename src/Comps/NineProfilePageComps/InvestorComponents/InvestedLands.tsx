  ...
  const resetFilter = () =>{
    ...
    return (
          ...
          <Container>
            <Box mb={1}>
              ...
              <Box width='100%' textAlign='center' py={2} className="text-container">
               <Typography className="FormheadingName" sx={{fontSize:'2.5rem' , fontWeight:700 ,letterSpacing:'0.3rem' ,textTransform:'uppercase' }} >Invested Lands</Typography>                  </Box>
                </Grid>
        ...
        <Skeleton sx={{ height: 190 }} animation="wave" variant="rectangular" />
          ...
          <>
            ...
            <Box display='flex' gap={1} flexDirection='row'>
                                ...
                                <Typography variant="body2" color="#455636">{i.InvestorCity}, {i.InvestorState}, {i.InvestorCountry}</Typography>
            </Box>
            <Box display='flex' gap={1} flexDirection='row'>
            <Typography variant="body2" color="#455636" fontWeight={600}>Status:</Typography>
                                <Typography variant="body2" color="#455636"> {i.InvestorStatus}</Typography>
            </Box>
            </Stack>
            </>
        )}
          ...
          <React.Fragment>
           ...
           <Box display='flex' justifyContent='space-between' flexDirection='row'>
            ...
            View
                          ...
                          <Button size="small" sx={{ color: '#D6A31E' }} onClick={()=>movedtoEditPage(i.InvestorId)}>
             Update
            </Button>
            </Box>
)}            
      ...
      <Grid item xs={12}>
        ...
        <Grid container spacing={1} display='flex' justifyContent='start' px={1}>
          {slicedData.map((i) => (
            <Grid item xs={12} sm={6} md={3} lg={3} key={i.InvestorId} my={2}>
              <Card sx={{ maxWidth: 250, bgcolor: '#E0E3DE', borderRadius: '10px', height:'100%' , display:'flex',flexDirection:'column',  justifyContent:'space-between' , boxShadow:5 }}>
                <Box p={2}>
                <CardActionArea sx={{ bgcolor: '#fff', borderRadius: '5px' }}>
        {Loading ? (
